...
/**
 * TestAESDecrypt128CFB1 - Decrypt ciphertext with specified 128-bit key in
...
/**
 * TestAESDecrypt128CFB8 - Decrypt ciphertext with specified 128-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt128CFB128 - Decrypt ciphertext with specified 128-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt192CFB1 - Decrypt ciphertext with specified 192-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt192CFB8 - Decrypt ciphertext with specified 192-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt192CFB128 - Decrypt ciphertext with specified 192-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt256CFB8 - Decrypt ciphertext with specified 256-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESDecrypt256CFB128 - Decrypt ciphertext with specified 256-bit key in
 * cipher feedback mode (CFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated plaintext matches expected value.
 */
...
/**
 * TestAESEncrypt128OFB - Encrypt plaintext with specified 128-bit key in
 * output feedback mode (OFB) mode and compare against expected ciphertext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
...
/**
 * TestAESEncrypt192OFB - Encrypt plaintext with specified 192-bit key in
 * output feedback mode (OFB) mode and compare against expected ciphertext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
...
/**
 * TestAESEncrypt256OFB - Encrypt plaintext with specified 256-bit key in
 * output feedback mode (OFB) mode and compare against expected ciphertext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
...
/**
 * TestAESDecrypt128OFB - Decrypt ciphertext with specified 128-bit key in
 * output feedback mode (OFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
...
/**
 * TestAESDecrypt192OFB - Decrypt ciphertext with specified 192-bit key in
 * output feedback mode (OFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
...
/**
 * TestAESDecrypt256OFB - Decrypt ciphertext with specified 256-bit key in
 * output feedback mode (OFB) mode and compare against expected plaintext.
 *
 * @return Pass if generated cipher text matches expected value.
 */
